...
CONFIG: Dict = {
    ...
    "model": {
        ...
        "mag_hidden": 128,
        "mag_use_prev_skip": False,
        "mag_predict_logvar": False,
    ...
    "loss": {
        ...
        "mag_loss": "huber",
        "mag_huber_delta": 1.0,
        "time_alpha_sisdr": 0.3,
        "time_beta_l1": 0.7,
        "cons_mode": "both",
        "cons_mag_only": False,
        "apply_window_in_overlap": True,
        "mrstft_scales": [(256, 64, 256), (512, 128, 512), (1024, 256, 1024)],
        "lambda_mrstft": 0.5,
    ...
    "eval": { "val_every": 1, "val_batches": None },
